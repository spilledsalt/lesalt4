...
country = {
	...
	CREATED_CB_VALID_TIME = 36,  -- how many months 
...
economy = {
	...
	MAX_LOAN_CAP_FROM_BANKS = 500, -- can loan max % of country tax base from single country
	...
	FACTORY_UPGRADE_EMPLOYEE_FACTOR = 0.6, -- determines how close to the employee limit we need to be before "upgrade all" will upgrade/expand a given factory (1 = 100%).
...
diplomacy = {
	...
	INCREASERELATION_RELATION_ON_ACCEPT = 25,
...
ai =
{
	...
	AGGRESSION_BASE = 6, -- general AI aggression
